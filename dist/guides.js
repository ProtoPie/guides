    ...
    ***************************************************************************** */
    ...
    function createElement(type, props) {
      ...
      return {
        ...
        key: key,
        ref: ref,
        props: __assign$2(__assign$2({}, otherProps), {
    ...
    function () {
      ...
      __proto.setState = function (state, callback, isForceUpdate) {
        ...
        this.$_timer = 0;
        this.$_state = __assign$2(__assign$2({}, this.$_state), state);
      ...
      __proto.$_setState = function (callback, isForceUpdate) {
        ...
        var isUpdate = renderProviders(provider.container, [provider], [provider.original], hooks, __assign$2(__assign$2({}, this.state), this.$_state), isForceUpdate);
    ...
    function diffProviders(containerProvider, providers, children) {
      ...
      return __spreadArrays$3(result.added, changed.map(function (_a) {
        var _ = _a[0],
            to = _a[1];
        return to;
      }));
