    ...
    var Guides = /*#__PURE__*/function (_super) {
      ...
      __proto.movePos = function (e) {
        ...
        if (!datas.fromRuler || !this._isFirstMove) {
          if (displayDragPos) {
            var translate = type === 'horizontal' ? this.calcHorizontalTransform(nextPos) : this.calcVerticalTransform(nextPos);
      ...
      __proto.calcHorizontalTransform = function (nextPos) {
        var translateY = nextPos - 10 + "px";
        return "translate(-18px, " + translateY + ") rotate(-90deg)";
      };
      __proto.calcVerticalTransform = function (nextPos) {
        var translateX = nextPos + 8 + "px";
